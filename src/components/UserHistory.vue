  ...
  <div class="user-history">
    ...
    <div class="user-history-container">
      ...
      <div class="user-history-list">
        <div class="user-history-list-item" v-for="(history, index) in histories" :key="index">
          <img :src="history.thumbnail" alt="">
          <div class="user-history-video-detail">
            <div class="user-history-video-detail-title" @click="jumpToVideoDetail(history.videoId)"
        ...
        <infinite-loading :identifier="infiniteId" @infinite="pageListUserHistory">
        </infinite-loading>
      </div>
    </div>
  </div>
