  ...
  <div class="my-space-post">
    <div class="my-space-post-container">
      ...
      <div class="my-space-post-classification">
        <el-menu :default-active.sync="activeIndex" class="filter-menu" mode="horizontal" @select="handleSelect">
          <el-menu-item class="filter-menu-item" v-for="area in areaList" :key="area.index" :index="area.index">
      ...
      <div class="my-space-post-videos">
        <div class="videos-item" v-for="(video,index) in videos" :key="index">
      ...
      <!--      分页展示视频-->
      <el-pagination class="page-list-videos" background layout="prev, pager, next" :page-size="pageSize"
        :current-page.sync="currentPage" @current-change="pageListUserVideos" :total="totalVideoCount">
      </el-pagination>
