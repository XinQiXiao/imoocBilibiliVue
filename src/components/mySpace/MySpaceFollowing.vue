    ...
    <div class="my-space-following-container">
      ...
      <div class="my-space-nav">
        ...
        <div class="title">
          ...
          <el-button type="info" plain icon="el-icon-plus" class="add-group-button" @click="showAddGroupDialog=true">
          </el-button>
          <el-dialog title="新建分组" :visible.sync="showAddGroupDialog" width="30%" center>
            <input type="text" v-model="groupName" placeholder="最多输入16个字" maxlength="16" style="width: 100%">
        ...
        <div class="my-space-menu">
          <div class="my-space-menu-item" @click="pageListUserCenterFollowings(null)">
            <div>
              全部
            </div>
          ...
          <div class="my-space-menu-item" v-for="(group, index) in followingGroups" :key="index"
      ...
      <div class="my-space-content">
        ...
        <div class="my-space-content-following" v-if="showFollowing">
          <div class="my-space-content-list">
            <div class="list-item" v-for="userFollowing in userFollowings" :key="userFollowing.id">
              <!--            用户信息-->
              ...
              <div class="operation">
                ...
                <el-dialog title="你正在移动1个关注用户" :visible.sync="showMoveFollowingGroupDialog" width="30%">
                  <MoveFollowingGroupDialog :followingGroups="followingGroups" :followingId="currentFollowingId"
          ...
          <div class="page-list-content-detail">
            <el-pagination background layout="prev, pager, next" :page-size="size" :current-page.sync="currentPage"
              @current-change="pageListUserCenterFollowings" :total="total">
            </el-pagination>
          </div>
        </div>
        <!--      粉丝-->
        <div class="my-space-content-fans" v-else>
          <div class="my-space-content-list">
            <div class="list-item" v-for="userFan in userFans" :key="userFan.id">
              <!--            用户信息-->
              <div class="item-infos">
                <div class="avatar">
              ...
              <div class="userFollowing-operation">
                <el-dropdown v-if="visible(userFan.userId)">
                  ...
                  <el-dropdown-menu>
                    <el-dropdown-item>
                      <el-button type="text" style="color: black" @click="setMoveFollowingGroupDialog(userFan.userId)">
                        设置分组
                      </el-button>
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <el-button type="text" style="color: black" @click="deleteUserFollowing(userFan.userId)">
                        取消关注
                      </el-button>
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
                <el-button type="info" plain v-else @click="addUserFollowing(userFan.userId)">
                  关注
                </el-button>
                <el-dialog title="你正在移动1个关注用户" :visible.sync="showMoveFollowingGroupDialog" width="30%">
                  <MoveFollowingGroupDialog :followingGroups="followingGroups" :followingId="currentFollowingId"
          ...
          <div class="page-list-content-detail">
            <el-pagination background layout="prev, pager, next" :page-size="size" :current-page.sync="currentPage"
              @current-change="pageListUserFans" :total="total">
            </el-pagination>
          </div>
        </div>
      </div>
