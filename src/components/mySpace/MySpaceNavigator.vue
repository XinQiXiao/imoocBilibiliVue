    ...
    <div class="my-space-content-container">
      ...
      <div class="my-space-userinfo-container">
        ...
        <div class="my-space-avatar" @click="selectAvatar">
          ...
          <input type="file" ref="fileInput" style="display: none" @change="setAvatar" accept="image/*">
        </div>
        <div class="info-wrap">
      ...
      <div class="my-space-navigator">
        <el-menu :default-active="activeIndex" class="navigator-menu" mode="horizontal">
          <el-menu-item class="navigator-menu-item" @click="jumpToPath(navigation.path)"
            v-for="navigation in navigationList" :key="navigation.index" :index="navigation.index">
            {{navigation.name}}
          </el-menu-item>
        </el-menu>
      </div>
