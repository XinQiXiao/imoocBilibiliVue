    ...
    <div class="my-space-collection-container">
      <div class="my-space-collection-nav">
        <div class="title">
          ...
          <el-button type="info" plain icon="el-icon-plus" class="add-group-button"
            @click="showAddCollectionDialog=true">
          </el-button>
          <el-dialog title="新建收藏夹" :visible.sync="showAddCollectionDialog" width="30%" center>
        ...
        <div class="my-space-collection-menu">
          <div class="my-space-collection-menu-item" v-for="group in collectionGroups"
            :key="collectionGroups.indexOf(group)" @click="handleMenuClick(group.groupId)">
            <div>
              {{group.groupName}}
            </div>
      ...
      <div class="my-space-collection-content">
        <div class="my-space-collection-videos">
          <div class="collection-videos-item" v-for="collection in collections" :key="collection.videoInfo.id">
              ...
              <div class="collection-video-info">
                ...
                <div class="collection-video-info-createTime">
                  ...
                  <el-dropdown trigger="click" style="cursor: pointer">
                    ...
                    <el-dropdown-menu>
                      <el-dropdown-item>
                        <el-button type="text" style="color: black" @click="deleteCollection(collection.videoInfo.id)">
                          取消收藏
                        </el-button>
                      </el-dropdown-item>
                      <el-dropdown-item>
          ...
          <div class="page-list-collections">
            <el-pagination background layout="prev, pager, next" :page-size="size" :current-page.sync="currentPage"
              @current-change="pageListUserCenterCollections(size, currentPage, currentGroupId)" :total="total">
            </el-pagination>
          </div>
        </div>
        <el-dialog title="你正在移动1个视频到" :visible.sync="showMoveCollectionDialog" width="30%">
          <MoveCollectionDialog :collectionGroups="collectionGroups" :moveVideoId="moveVideoId"
