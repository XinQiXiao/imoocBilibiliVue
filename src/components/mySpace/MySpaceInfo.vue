  ...
  <div class="my-space-info">
    ...
    <div class="my-space-info-item">
      ...
      <div class="my-space-info-item-body">
        <input type="text" autocomplete="off" placeholder="你的昵称" maxlength="16" style="height:30px; width: 225px;
             outline: none; font-size: 18px;" v-model="userInfo.nick">
      </div>
    </div>
    ...
    <div class="my-space-info-item">
      ...
      <div class="my-space-info-item-body">
        <textarea autocomplete="off" placeholder="设置您的签名- ( ゜- ゜)つロ" rows="2" style="min-height: 32px;
                width: 618px; height: 88px;
                resize: none; font-size: 18px; outline: none;" v-model="userInfo.sign">
      </textarea>
      </div>
    </div>
    ...
    <div class="submit-btn">
      <el-button type="primary" style="width: 140px;" @click="updateUserInfo">保存</el-button>
    </div>
