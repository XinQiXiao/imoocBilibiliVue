<template>
  <div class="my-space-home">
    ...
    <div class="home-post-content">
      <div class="home-post-content-item" v-for="(myPostVideo,index) in myPostVideos" :key="index">
    ...
    <div class="home-collection-content">
      <div class="home-collection-content-item" v-for="(collectionGroup, index) in myCollectionGroups" :key="index">
    ...
    methods: {
      ...
      async pageListVideos() {
        try {
          ...
          console.log('pageListVideos error=>', error);
        }
