      ...
      <div v-if="!this.isUserLoggedIn" class="comment-body-before-login">
        <div class="comment-send-area-before-login">
          ...
          <div class="comment-input-before-login">
            <textarea class="comment-input-textarea" placeholder="请登录后再观看和发表评论" v-model="comment">
            </textarea>
          </div>
      ...
      <div v-else class="comment-body-login">
        ...
        <div class="comment-send-area">
          ...
          <div class="comment-input">
            <textarea class="comment-input-textarea" placeholder="天青色等烟雨，评论区在等你" v-model="comment">
            </textarea>
          </div>
        ...
        <div v-if="videoCommentList.length > 0">
          <div class="comment-root-reply-container" v-for="rootComment in videoCommentList" :key="rootComment.id">
            ...
            <div class="total-reply-content-container">
              ...
              <div class="root-reply-content-container">
                ...
                <div class="root-reply-content">
                  ...
                  <div class="root-reply-content-operation">
                    ...
                    <div class="reply-btn" @click="recordCurrentClickedComment(rootComment.id,
              ...
              <!--              二级结构-->
              <div class="sub-reply-content-container" v-for="childComment in rootComment.childList"
                :key="childComment.id">
                ...
                <div class="sub-reply-content">
                  ...
                  <div class="sub-reply-content-operation">
                    ...
                    <div class="reply-btn" @click="recordCurrentClickedComment(childComment.id,
              ...
              <!--              回复某一个用户的评论区域-->
              <div class="reply-comment-area" v-if="currentCommentId === rootComment.id
                   || rootComment.childList.some(item => item.id === currentCommentId)">
                <div class="reply-user-avatar">
                  <img :src="avatar" alt="">
                </div>
                <div class="reply-comment-input">
                  <textarea class="comment-input-textarea" :placeholder="'回复' + commentUserName" v-model="replyTxt">
                  </textarea>
                </div>
