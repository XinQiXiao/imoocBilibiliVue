<template>
  <div>
    ...
    <div class="search-contents-container">
      <el-menu :default-active="activeIndex" class="search-contents-nav-menu" mode="horizontal">
        <el-menu-item class="search-contents-nav-menu-item" v-for="item in menuList" :index="item.index"
          :key="menuList.indexOf(item)" @click="currentTab = item.tab">
