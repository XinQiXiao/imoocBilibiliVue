<template>
  <div class="search-contents-videos-container">
    ...
    <div class="search-contents-videos">
      <div class="search-contents-videos-item" v-for="video in videos" :key="video.id">
        <div class="search-contents-videos-item-detail">
          ...
          <div class="search-contents-videos-info">
            <div class="search-contents-videos-info-title" @click="jumpToVideoDetail(video.id)">
    ...
    <div class="page-list-videos">
      <el-pagination background layout="prev, pager, next" :page-size="pageSize" :current-page.sync="currentPage"
        @current-change="searchVideos" :total="totalVideoCount">
      </el-pagination>
    </div>
  </div>
</template>
