  ...
  <div class="user-moments">
    ...
    <div class="user-moments-container">
      ...
      <div class="user-moments-post">
        <input placeholder="有什么想和大家分享的？" class="user-moments-post-input" v-model="postTxt">
        <div class="user-moments-post-img">
          <img :src="imagePreview" alt="" v-show="imagePreview" class="uploaded-img">
        </div>
        <div class="user-moments-post-tools">
          <div class="user-moments-post-tools-img">
            <label for="file-input">
              <img :src="require('@/assets/icon/uploadImg.png')" alt="" class="icon">
            </label>
            <input type="file" id="file-input" style="display: none;" accept="image/*" @change="handleImageUpload">
          </div>
      ...
      <div class="user-moments-nav">
        <el-menu :default-active.sync="activeIndex" class="user-moments-nav-menu" mode="horizontal">
          <el-menu-item v-for="menu in menus" :key="menu.index" :index="menu.index" class="user-moments-nav-menu-item"
      ...
      <div class="user-moments-list">
        <div class="user-moments-list-item" v-for="(moment, index) in moments" :key="index">
            ...
            <div class="user-moments-list-item-moment-video" v-if="moment.type==='0' ">
              ...
              <div class="user-moments-list-item-moment-video-detail">
                <div class="user-moments-list-item-moment-video-detail-title"
                  @click="jumpToVideoDetail(moment.content.contentDetail.id)" style="cursor: pointer">
        ...
        <infinite-loading :identifier="infiniteId" @infinite="pageListMoments">
        </infinite-loading>
      </div>
    </div>
  </div>
