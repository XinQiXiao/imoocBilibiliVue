    ...
    <div class="video-form">
      ...
      <div class="video-title">
        ...
        <div class="video-title-input">
          <input type="text" v-model="videoInfo.title" maxlength="80" placeholder="请输入标题" class="input-val">
        </div>
      </div>
      ...
      <div class="video-tag">
        <div class="video-tag-container">
          ...
          <div class="video-tag-input">
            <input type="text" maxlength="80" placeholder="按回车键Enter创建标签" class="input-val" ref="tagInput"
      ...
      <div class="video-description">
        ...
        <div class="video-description-input">
          <input type="text" v-model="videoInfo.description" maxlength="80" placeholder="请输入简介" class="input-val">
        </div>
      </div>
      <div class="submit-video">
        <el-button @click="postVideo" type="primary" style="margin: 40px; width: 200px;">
          立即投稿
        </el-button>
      </div>
    </div>
    ...
    async uploadVideo(){
      if(this.selectedFile){
        ...
        if(response){
          ...
          console.log('uploadVideo videoInfo=>',this.videoInfo);
